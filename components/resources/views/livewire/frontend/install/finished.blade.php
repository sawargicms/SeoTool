<div class="text-center">
    ...
    <p>{{ __('Please come back and') }}<a class="text-primary" href="https://s.ytgo.live/seotool/rating"> {{ __('leave a 5-star rating') }} </a>{{ __('if you are happy with this script.') }}</p>
    <div class="row">
        <div class="col-md-12">
