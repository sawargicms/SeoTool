        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" wire:model="robots_index">
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" wire:model="robots_links">
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" wire:model="content_type">
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" wire:model="revisit_days">
