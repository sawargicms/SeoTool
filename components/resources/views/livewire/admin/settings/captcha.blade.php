        ...
        <div class="col-12 mb-4">
            <div class="card">
                <div class="card-header bg-gradient-info">
                    <h6 class="card-title text-white mb-0">{{ __('reCAPTCHA v3') }} (<a href="https://docs.Midhunter.com/sumowebtools/getting-started/how-to-get-google-recaptcha-v3-keys/" target="_blank" class="text-white">{{ __('How to get Google reCAPTCHA v3 Keys') }}</a>)</h6>
                </div>
                <div class="card-body">
