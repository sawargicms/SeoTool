<div>
    ...
    <form wire:submit.prevent="onUpdateAPIKeys" class="row">
        ...
        <div class="col-12 mb-4">
            <div class="card">
                <div class="card-header bg-gradient-info">
                    <h6 class="card-title text-white mb-0">{{ __('Facebook') }} (<a href="https://docs.Midhunter.com/sumoseotools/getting-started/how-to-get-facebook-cookies/" target="_blank" class="text-white">{{ __('How to get Facebook Cookies') }}</a>)</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-12 mb-4">
            <div class="card">
                <div class="card-header bg-gradient-info">
                    <h6 class="card-title text-white mb-0">{{ __('Moz') }} (<a href="https://docs.Midhunter.com/sumoseotools/getting-started/how-to-get-moz-access-id-and-secret-key/" target="_blank" class="text-white">{{ __('How to get Moz access id and secret key') }}</a>)</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table settings">
