...
<head>
    ...
    <title>{{ __('About - XdSEOTools') }}</title>
                ...
                <div class="container-fluid py-4">
                  <div class="row">
                    <div class="col">
						...
						<div class="card">
							<div class="card-body">
								<p>{{ __('Thank you for purchasing our XdSEOTools script. We have put in lots of love in developing this product and are excited that you have chosen this script for your website. We hope you find it easy to use our product.') }}</p>
								<a class="btn btn btn-icon btn-3 bg-gradient-success" href="https://s.ytgo.live/seotool" target="_blank">
                                    <i class="fas fa-download fa-fw"></i>
                                    {{ __('Download Now') }}
                                </a>

								<a href="https://s.ytgo.live/seotool" target="_blank" class="btn btn btn-icon btn-3 bg-gradient-primary">
